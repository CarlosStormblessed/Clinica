...
public class ConsultaGeneral extends javax.swing.JFrame implements ActionListener, TableModelListener{
    ...
    private RevisionSistemasCtrl revisionSistemasCtrl = new RevisionSistemasCtrl();
    ...
    private void construirEtiquetas(){
        String codigo;
        try {
            codigo = fichaClinicaCtrl.getMaxId();
    ...
    private DatosPaginacion <FichaClinicaMod> crearDatosPaginacionFicha() throws SQLException, ConnectException{
        ...
        for (int i = 0; i < lista.size(); i++){
            ficha = lista.get(i);
            emp = empleadoCtrl.buscarFila(ficha.getEmpleadoId());
    ...
    private void buscarEmpleadoFichaClinica(String valorBuscar) throws SQLException, ConnectException{
        ...
        setFichaClinica();
        empleado = empleadoCtrl.buscarFila(fichaClinica.getEmpleadoId());
        setEmpleado();
    }
    ...
    private void crear() throws SQLException{
        try {
            ...
            revSis = revisionSistemasCtrl.Crear(revisionSistemas);
            if (revSis > 0){
                revisionSistemas.setId(revisionSistemasCtrl.getMaxId());
                fichaClinica.setRevisionSistemasId(revisionSistemas.getId());
                conGen = fichaClinicaCtrl.Crear(fichaClinica);
                if (conGen > 0) {
    ...
    private void actualizar() throws SQLException{
        try {
            int conGen = 0, revSis = 0;
            revSis = revisionSistemasCtrl.Actualizar(revisionSistemas);
            if (revSis > 0){
                conGen = fichaClinicaCtrl.Actualizar(fichaClinica);
                if (conGen > 0) {
    ...
    private void eliminar() throws SQLException{
        try {
            int conGen = 0;
            conGen = fichaClinicaCtrl.Eliminar(fichaClinica);
            if (conGen > 0) {
    ...
    private void initComponents() {
        ...
        panelFormulario.add(panelCartasEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 490, 215));
        ...
        panelPagina1.add(lbl_RevisionPorSistemas, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, 20));

        lblTemperatura.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblTemperatura.setText("Temperatura");
        panelPagina1.add(lblTemperatura, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1, 20));
        ...
        panelPagina1.add(txtTemperatura, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 101, 35));

        lblPulso.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblPulso.setText("Pulso");
        panelPagina1.add(lblPulso, new org.netbeans.lib.awtextra.AbsoluteConstraints(343, 40, -1, 20));
        ...
        panelPagina1.add(txtPulso, new org.netbeans.lib.awtextra.AbsoluteConstraints(343, 60, 101, 35));

        lblSPO2.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblSPO2.setText("sPO2");
        panelPagina1.add(lblSPO2, new org.netbeans.lib.awtextra.AbsoluteConstraints(454, 40, -1, 20));
        ...
        panelPagina1.add(txtSPO2, new org.netbeans.lib.awtextra.AbsoluteConstraints(454, 60, 101, 35));

        lblFR.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblFR.setText("FR");
        panelPagina1.add(lblFR, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 105, -1, 20));
        ...
        panelPagina1.add(txtFR, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 125, 129, 35));

        lblGlicemia.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblGlicemia.setText("Glicemia");
        panelPagina1.add(lblGlicemia, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 40, -1, 20));
        ...
        panelPagina1.add(txtGlicemia, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 60, 101, 35));

        lblPeso.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblPeso.setText("Peso");
        panelPagina1.add(lblPeso, new org.netbeans.lib.awtextra.AbsoluteConstraints(288, 105, -1, 20));
        ...
        panelPagina1.add(txtPeso, new org.netbeans.lib.awtextra.AbsoluteConstraints(288, 125, 129, 35));

        lblTalla.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblTalla.setText("Talla");
        panelPagina1.add(lblTalla, new org.netbeans.lib.awtextra.AbsoluteConstraints(427, 105, -1, 20));
        ...
        panelPagina1.add(combo_Talla, new org.netbeans.lib.awtextra.AbsoluteConstraints(427, 125, 129, 35));

        lblIMC.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblIMC.setText("IMC");
        panelPagina1.add(lblIMC, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 105, -1, 20));
        ...
        panelPagina1.add(txtIMC, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 125, 135, 35));

        lblPA.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblPA.setText("P/A");
        panelPagina1.add(lblPA, new org.netbeans.lib.awtextra.AbsoluteConstraints(232, 40, -1, -1));
        ...
        panelPagina1.add(txtPA, new org.netbeans.lib.awtextra.AbsoluteConstraints(232, 60, 101, 35));

        lblOjoDerecho.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblOjoDerecho.setText("Agudeza ojo derecho");
        panelPagina1.add(lblOjoDerecho, new org.netbeans.lib.awtextra.AbsoluteConstraints(155, 170, -1, 20));
        ...
        panelPagina1.add(txtOjoDerecho, new org.netbeans.lib.awtextra.AbsoluteConstraints(155, 190, 135, 35));

        lblOjoIzquierdo.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblOjoIzquierdo.setText("Agudeza ojo izquierdo");
        panelPagina1.add(lblOjoIzquierdo, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, -1, 20));
        ...
        panelPagina1.add(txtOjoIzquierdo, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, 135, 35));
        ...
        panelPagina1.add(checkLentes, new org.netbeans.lib.awtextra.AbsoluteConstraints(446, 190, 110, 35));

        lblRuffier.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblRuffier.setText("Ruffier");
        panelPagina1.add(lblRuffier, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, -1, 20));
        ...
        panelPagina1.add(txtRuffier, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 129, 35));
        ...
        panelPagina2.add(jScrollPane13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 260, 30));
        ...
        panelPagina2.add(jScrollPane14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 260, 30));
        ...
        panelPagina2.add(jScrollPane15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 260, 30));
        ...
        panelPagina2.add(jScrollPane23, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 260, 30));
        ...
        panelPagina2.add(jScrollPane24, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 70, 260, 30));
        ...
        panelPagina2.add(jScrollPane18, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 130, 260, 30));
        ...
        panelPagina2.add(jScrollPane19, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 190, 260, 30));
        ...
        panelPagina2.add(jScrollPane20, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, 260, 30));
        ...
        panelPagina3.add(jScrollPane21, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 260, 30));
        ...
        panelPagina3.add(jScrollPane22, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 260, 30));
        ...
        panelPagina3.add(jScrollPane25, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 30, 260, 30));
        ...
        panelPagina3.add(jScrollPane26, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 90, 260, 30));
        ...
        panelFormulario.add(panelCartas, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 0, 566, 365));
        ...
        panelAuxiliar.add(jScrollPane16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 470, 30));
        ...
        panelFormulario.add(panelAuxiliar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 215, 490, 215));
        ...
        cont_ConsultaGeneral.add(panelCartasContenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 1080, 430));
